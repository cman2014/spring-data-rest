...
public class ConfigurableHttpMethods implements HttpMethods {
	...
	public ConfigurableHttpMethods disable(HttpMethod... methods) {
		...
		return new ConfigurableHttpMethods( //
		//
		this.methods.stream().filter(it -> !toRemove.contains(it)).collect(Collectors.toSet()));
	}
	...
	private ConfigurableHttpMethods(final Collection<HttpMethod> methods) {
		this.methods = methods;
	}

	@java.lang.SuppressWarnings("all")
	static ConfigurableHttpMethods of(final Collection<HttpMethod> methods) {
